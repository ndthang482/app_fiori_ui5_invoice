		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "invoice",
									"targetURL": "#comdemoappodatademoapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemoappodatademoapp-display": {
								"semanticObject": "comdemoappodatademoapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.app.odatademoapp",
									"url": sap.ui.require.toUrl("com/demo/app/odatademoapp")
								}
							}
						}
					}
